    ...
    class Room:AdvObj
    {
      ...
      public List<Character> POTS
        ...
        static public List<Room> CreateRooms()
        {
            ...
            room1 = new Room(29, 15, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(10) }, false, false, true, true, false, "Room 1", "You entered a room. It smells...", 301);
            room2 = new Room(33, 15, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(2), MainGame.ChestL.ElementAt(3) }, false, false, false, false, true, "Room 2", "You entered a room. It's dark...", 302);
            roomB = new Room(37, 15, new List<Character>(), new List<Character>(), new List<Chest>  {MainGame.ChestL.ElementAt(13) }, false, false, false, true, false, "Room B", "As you step into the room, the door slams shut behind you \nwith a loud clang.Inside is a dimly lit room smelling \nfaintly of potpourri and wizardry.", 316);//  In the middle, tied to pillar is Zorldo", 316);
            ...
            room4 = new Room(45, 15, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(5) }, false, false, true, false, true, "Room 4", "You entered a room.", 304);
            room5 = new Room(29, 18, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(18) }, false, true, true, false, false, "Room 5", "You entered a room.", 305);
            room6 = new Room(37, 18, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(12),MainGame.ChestL.ElementAt(17) }, false, false, true, false, false, "Room 6", "You entered a room.", 306);
            ...
            room8 = new Room(29, 21, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(7) }, false, true, false, true, false, "Room 8", "You entered a room.", 308);
            ...
            room10 = new Room(37, 21, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(4) }, false, true, true, true, true, "Room 10", "You entered a room. This room makes you feel good... Don't ask why...", 310);
            ...
            room12 = new Room(45, 21, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(0),MainGame.ChestL.ElementAt(1) }, false, true, false, false, true, "Room 12", "You entered a room.", 312);
            room13 = new Room(33, 24, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(11) }, false, false, false, true, false, "Room 13", "You entered a room.", 313);
            room14 = new Room(37, 24, new List<Character>(), new List<Character>(), new List<Chest>(), true, true, false, true, true, "Room 14", "You entered a room. Haven't I been here before?", 314);
            room15 = new Room(41, 24, new List<Character>(), new List<Character>(), new List<Chest> { MainGame.ChestL.ElementAt(16) }, false, true, false, false, true, "Room 15", "You entered a room.", 315);
        ...
        public Character Randomizer(string monstPot, List<Character> Pots)
        {
            if (monstPot == "monster")
            {
                ...
                monster = Enemies.ElementAt(rand.Next(0, 5));
                return monster;
            }
